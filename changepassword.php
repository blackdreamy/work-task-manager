<?php 
  ...
  if (!isset($_SESSION['user'])) {
    ...
    // проверяем совпадает ли логин и пароль с бд
		    $query = "UPDATE `workers` SET `password` = '$password_1' WHERE `user`='$username'";
  ...
  <div class="header">
  	<h2>Change password</h2>
		    	...
		    	<form method="post" action="changepassword.php">
					  	...
					  	<div class="input-group">
					  	  <button type="submit" class="btn" name="change_password" id='changepasswordbutton'>Change password</button>
